...
export function InputTextDashboard({
  ...
  return (
    <div className="w-full flex flex-col">
      <input
        {...props}
        className={`border border-primary-300 px-2 py-1 rounded-lg focus:outline-none focus:border-secondary-300`}
        disabled={disabled}
        type={type}
        placeholder={placeholder}
      />
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <input
        ...
        className="hidden"
      />
      <span className="text-sm text-danger-300 text-center">{error}</span>
